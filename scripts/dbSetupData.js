...
async function testData() {
	try{
		const data = [
			...
			{ questionId: 6, question: 'In Which 1990s sitcom, set in California, starred comic actor Will Smith?', answer: 'o2', o1:'Cheers', o2:'Fresh Prince Of Bel-Air', o3:'Mork And Mindy', o4:'The Golden Girls' }
		]
